...
function galerie3d_description_shortcode() {
    $desc = get_option('galerie3d_description');
    if (!empty($desc)) {
        return '<div class="galerie3d-description">' . wp_kses_post($desc) . '</div>';
    }
    return '';
}
add_shortcode('galerie3d_description', 'galerie3d_description_shortcode');
